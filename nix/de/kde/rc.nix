{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-2907c465-1625-44ee-a5da-b7529a4ba05b" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,1,10,17,23,1.754";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."2907c465-1625-44ee-a5da-b7529a4ba05b" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "2907c465-1625-44ee-a5da-b7529a4ba05b";
      "kcminputrc"."Libinput/12972/18/Framework Laptop 16 Keyboard Module - ANSI Consumer Control"."NaturalScroll" = false;
      "kcminputrc"."Libinput/2362/628/PIXA3854:00 093A:0274 Touchpad"."NaturalScroll" = true;
      "kcminputrc"."Libinput/9610/54/Glorious Model O"."PointerAccelerationProfile" = 1;
      ...
      "kwinrc"."Tiling/cab8ec11-8b76-5d63-9d4f-2c81debe5a1c"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
